...
class View extends Smarty{
    ...
    function create_url($path){
        ...
        $url_index = APP.'/app/'.$dir_index.'/index.php';

        //ﾌｧｲﾙを除外
        unset($params[$file_no]);

        $url = APP.'/app/'.$class_name.'/controller_'.$class_name.'.php';

        if(!file_exists(APP.'/app/'.$class_name.'/controller_'.$class_name.'.php')){
...
die;
    ...
    function render( $temp_path ){
        ...
        $template_path = APPLICATION.'/'.$temp_path;
