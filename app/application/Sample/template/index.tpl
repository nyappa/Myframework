...
Smarty is used for a template engine. <br>
When you develop, please create the folder for every application to an application folder,<br>
and create the class of the name of controller_hogeho in it.<br>
<br>
